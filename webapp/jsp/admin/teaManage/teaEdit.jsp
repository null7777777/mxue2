...
<head>
    ...
    <style type="text/css">
        ...
        .img-box{
        	width: 100px;
        	height:100px;
        	background:url("images/tea/noneImg.jpg") no-repeat center;
...
<div class="container">
    ...
    <div class="row">
    	...
    	<div class="col-sm-4 ">
    		<div class="img-box" onclick="javascript:upImg()">
    			<img alt="" height="100px" src="${teaInfo.upLoadImg.imgSrc}" >
    		</div>
    		<span id="imgSpan">点击图片更改图片</span>
    		<form id="imgForm" action="jsp/admin/TeaManageServlet?action=updateImg&id=${teaInfo.teaId}" method="post" enctype="multipart/form-data">
    ...
    <form id="teaAddForm" class="form-horizontal" action="jsp/admin/TeaManageServlet?action=update" method="post">
                ...
                <select name="catalog" id="catalog" class="form-control">
                    ...
                    <c:if test="${!empty catalog}">
                        <c:forEach items="${catalog}" var="i">
                            <c:choose>
                                <c:when test="${i.catalogId eq teaInfo.catalog.catalogId}">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <input type="text" name="price" id="price" class="form-control" value="${teaInfo.price}">
            </div>
            <div class="col-sm-4 Validform_checktip"></div>
        </div>
    	...
    	<div class="form-group">
            ...
            <div class="col-sm-4">
                <textarea rows="3" name="desc" id="desc" class="form-control" >${teaInfo.description}</textarea>
            </div>
