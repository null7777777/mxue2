...
<head>
	...
	<link href="css/tea/user_reg_login.css" rel="stylesheet" type="text/css">
...
<c:if test="${!empty infoList}">
	...
	<div>
		...
		<div class="wrapper" style="background:url(images/tea/loginbg.jpg);margin-top:-20px;background-repeat:no-repeat;background-size:cover;">
			<!-- main start -->
