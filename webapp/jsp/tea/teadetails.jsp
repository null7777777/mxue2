	...
	<div class="container-fullid">
		...
		<div class="wrapper">
			...
			<div class="main container">
				<div class="sub-nav">
					<ol class="breadcrumb">
  						<li><a href="jsp/tea/index.jsp">主页</a></li>
						<li><a href="#">${teaInfo.catalog.catalogName}</a></li>
						<li class="active">${teaInfo.teaName}</li>
					</ol>
				</div>
				<div class="row">
					<div class="col-md-5">
						<img class="img-responsive" src="${teaInfo.upLoadImg.imgSrc}" />
					</div>
					<div class="col-md-7">
						<table class="pro_info">
								<tr>
									<td colspan="3"><h2>${teaInfo.teaName}</h2></td>
								</tr>
								<tr>
									<td>价格：</td>
									<td><i>￥${teaInfo.price}</i></td>
								</tr>
								<tr>
									<td>商品编号：</td>
									<td>${teaInfo.teaId}</td>
								...
								<tr>
									<td>商品分类：</td>
									<td>${teaInfo.catalog.catalogName}</td>
								</tr>
								
								
								<tr>
									<td>上架日期：</td>
									<td>${teaInfo.addTime}</td>
								</tr>
								<tr>
									<td>服务：</td>
									<td>由TEA SHOP发货,我们会全力加快为您服务！</td>
								</tr>
							</table>
						<p class="buy_pro">
								<a class="btn" style="border:1px solid black;" href="#">立即购买</a>
								<button type="button" class="btn" style="background:#333333;color:#fff;" onclick="addToCart(${teaInfo.teaId})" data-toggle="modal" data-target=".bs-example-modal-sm">
